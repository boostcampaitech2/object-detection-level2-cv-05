...
def parse_opt(known=False):
    ...
    parser.add_argument('--project', default=ROOT / 'Trash_Detect', help='save to project/name')
    parser.add_argument('--name', default='yolov5x6_all', help='save to project/name')
    ...
    parser.add_argument('--entity', default='friends', help='W&B: Entity')
