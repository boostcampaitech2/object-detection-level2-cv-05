...
def train(data_dir, model_dir, args):
    ...
    model.load_state_dict(torch.load("/opt/ml/mycode/custom_model/model/exp4/last.pth", map_location=device))
    ...
    scheduler = CosineAnnealingWarmRestarts(optimizer, T_0=5, T_mult=1, eta_min=0.000001)
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val_acc:
                ...
                for n, v in model.module.state_dict().items():
                    name = n.replace("model.","")
                    new_state_dict[name] = v
                torch.save(new_state_dict, f"{save_dir}/best.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=2147, help='random seed (default: 42)')
    ...
    wandb.init(project="Trash_Detect",
